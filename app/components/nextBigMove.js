...
export default function NextBigMove() {
  return (
    <div className="mt-[5em] flex flex-col md:w-[40em] max-md:w-[80vw] font-bold m-auto">
        ...
        <span className="text-center text-[#858694]">Embark on a crowdfunding journey where your projects come to life through seamless integration. Join forces with Lonktify, your gateway to crowdfunding success</span>
