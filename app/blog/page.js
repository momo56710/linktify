...
export default function page() {
  return (
    <div className='my-10'>
      <div className='max-w-[25em] m-auto mb-10'>
      ...
      <div className='bg-white flex gap-10 p-10'>
        <div className='relative overflow-hidden flex-1 rounded-[30px] max-w-[1600px] m-auto'>
          <img src={bolgImg.src} className='absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] max-md:h-full' />
      ...
      <div className='max-w-[1600px] m-auto'>
        ...
        <div className='flex flex-wrap gap-5 justify-center max-md:w-[90vw] max-md:m-auto'>
        {
